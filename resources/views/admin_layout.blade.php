	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{URL::to('/')}}" target="_blank"><span>Metro</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/allSubCategory')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">All Sub-Category</span></a></li>
						<li><a href="{{URL::to('/addSubCategory')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Sub-Category</span></a></li>
						<li><a href="{{URL::to('/addBrand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Brand</span></a></li>
						<li><a href="{{URL::to('/allBrand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">All Brand</span></a></li>
						<li>
						...
						<li><a href="{{URL::to('/allOrder')}}"><i class="icon-edit"></i><span class="hidden-tablet">Order </span></a></li>
						<li><a href="form.html"><i class="icon-edit"></i><span class="hidden-tablet">Social Link</span></a></li>
						<li><a href="chart.html"><i class="icon-list-alt"></i><span class="hidden-tablet">Shop Name</span></a></li>
						<!-- <li><a href="typography.html"><i class="icon-font"></i><span class="hidden-tablet">Slider</span></a></li> -->
