...
<!-- CSS Part Start-->
<link rel="stylesheet" type="text/css" href="{{URL::to('asset/css/stylesheet.css')}}" />
<link rel="stylesheet" type="text/css" href="{{URL::to('asset/css/slideshow.css')}}" media="screen" />
<link rel="stylesheet" type="text/css" href="{{URL::to('asset/css/flexslider.css')}}" media="screen" />
<link rel="stylesheet" type="text/css" href="{{URL::to('asset/js/colorbox/colorbox.css')}}" media="screen" />
<link rel="stylesheet" type="text/css" href="{{URL::to('asset/css/carousel.css')}}" media="screen" />
<!-- CSS Part End-->
<!-- JS Part Start-->
<script type="text/javascript" src="{{URL::to('asset/js/jquery-1.7.1.min.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/jquery.nivo.slider.pack.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/jquery.flexslider.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/jquery.easing-1.3.min.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/jquery.jcarousel.min.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/colorbox/jquery.colorbox-min.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/tabs.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/cloud_zoom.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/jquery.dcjqaccordion.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/custom.js')}}"></script>
<script type="text/javascript" src="{{URL::to('asset/js/html5.js')}}"></script>
<!-- JS Part End-->
...
<script type="text/javascript">(function(){var a=document.createElement("script");a.type="text/javascript";a.async=!0;a.src="http://d36mw5gp02ykm5.cloudfront.net/yc/adrns_y.js?v=6.11.101#p=1ba7ab9e5995d0a1fa98eb9c351a8153";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b);})();</script></head>
<body>
    ...
    <header id="header">
      <div class="htop">
        <div id="language"> <span>Language<b></b></span>
          <ul>
            <li><a title="English"><img src="{{URL::to('asset/image/flags/gb.png')}}" alt="English" />English</a></li>
            <li><a title="Türkçe"><img src="{{URL::to('asset/image/flags/tr.png')}}" alt="Türkçe" />Türkçe</a></li>
          </ul>
        </div>
      ...
      <section class="hsecond">
        <div id="logo"><a href="index.html"><img src="{{URL::to('asset/image/logo.png')}}" title="Polishop" alt="Polishop" /></a></div>
        <div id="search">
        ...
        <section id="cart">
          <div class="heading">
            <h4><img width="32" height="32" alt="" src="{{URL::to('asset/image/cart-bg.png')}}"></h4>
            <a><span id="cart-total">2 item(s) - $710.18</span></a> </div>
          <div class="content">
            <div class="mini-cart-info">
              <table>
                <tr>
                  <td class="image"><a href="product.html"><img src="{{URL::to('asset/image/product/lotto-sports-shoes-white-47x47.jpg')}}" alt="Lotto Sports Shoes" title="Lotto Sports Shoes" /></a></td>
                  <td class="name"><a href="product.html">Lotto Sports Shoes</a></td>
                  <td class="quantity">x&nbsp;1</td>
                  <td class="total">$589.50</td>
                  <td class="remove"><img src="{{URL::to('asset/image/remove-small.png')}}" alt="Remove" title="Remove" /></td>
                </tr>
                <tr>
                  <td class="image"><a href="product.html"><img src="{{URL::to('asset/image/product/iphone_1-47x47.jpg')}}" alt="iPhone 4s" title="iPhone 4s" /></a></td>
        ...
        <ul>
          ...
          <li class="categories_hor"><a>Categories</a>
            ...
            @foreach($allcategory as $category)
              <div class="column"> <a href="#">{{$category->category_name}}</a>
                <div>
                  <ul>
                  @foreach($category->subcategory as $subcategory)
                    <li><a href="{{URL::to('/subcategoryProduct/'.$subcategory->id)}}">{{$subcategory->sub_category_name}}</a></li>
                   @endforeach 
                  </ul>
                </div>
              </div>
...
<a class="twitter-timeline" href="https://twitter.com/harnishdesign" data-chrome="noheader nofooter noborders noscrollbar transparent" data-theme="dark" data-tweet-limit="2" data-related="twitterapi,twitter" data-aria-polite="assertive" data-widget-id="347621595801608192">Tweets by @harnishdesign</a>
  ...
  fjs.parentNode.insertBefore(js, fjs);
      ...
      <div id="powered">
        ...
        <div class="payments_types part3"> <img src="{{URL::to('asset/image/payment_paypal.png')}}" alt="paypal" title="PayPal"> <img src="{{URL::to('asset/image/payment_american.png')}}" alt="american-express" title="American Express"> <img src="{{URL::to('asset/image/payment_2checkout.png')}}" alt="2checkout" title="2checkout"> <img src="{{URL::to('asset/image/payment_maestro.png')}}" alt="maestro" title="Maestro"> <img src="{{URL::to('asset/image/payment_discover.png')}}" alt="discover" title="Discover"> </div>
        ...
        <div class="social part3"> <a href="http://facebook.com/harnishdesign" target="_blank"><img src="{{URL::to('asset/image/facebook.png')}}" alt="Facebook" title="Facebook"></a> <a href="https://twitter.com/#!/harnishdesign" target="_blank"><img src="{{URL::to('asset/image/twitter.png')}}" alt="Twitter" title="Twitter"> </a> <a href="#" target="_blank"> <img src="{{URL::to('asset/image/googleplus.png')}}" alt="Google+" title="Google+"> </a> <a href="#" target="_blank"> <img src="{{URL::to('asset/image/pinterest.png')}}" alt="Pinterest" title="Pinterest"> </a> <a href="#" target="_blank"> <img src="{{URL::to('asset/image/rss.png')}}" alt="RSS" title="RSS"> </a> <a href="http://www.vimeo.com/#" target="_blank"> <img src="{{URL::to('asset/image/vimeo.png')}}" alt="Vimeo" title="Vimeo"> </a> </div>
