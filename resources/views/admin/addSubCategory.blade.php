...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<form class="form-horizontal" action="{{url('/storeSubCategory')}}" method="post">
			{{csrf_field()}}
			  <fieldset>
				<div class="control-group">
				  <label class="control-label" for="CategoryName">Sub-Category Name</label>
				  <div class="controls">
					<input type="text" class="input-xlarge" id="CategoryName" name="sub_category_name">
				  </div>
				</div>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<textarea class="cleditor" id="CategoryDescription" name="sub_category_description" rows="10"></textarea>
				  </div>
				</div>
